            ...
            <section class="hero" id="section_1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 m-auto">
                            <div class="hero-text">
                                ...
                                <a class="custom-link bi-arrow-down arrow-icon"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="video-wrap">
                    <video autoplay="" loop="" muted="" class="custom-video" poster="">
                        <source src="../../videos/fondoVete.mp4" type="video/mp4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 d-flex flex-column justify-content-center align-items-center">
                            <div class="speakers-text-info">
                                <h2 class="mb-4">Que desea <u class="text-info">Cargar?</u></h2>

                                <p>Enriquece nuestro registro con información sobre tus queridos animales, personas destacadas o profesionales de confianza. ¡Ayúdanos a crear una comunidad más completa!</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="speakers-thumb">
                                <img src="../../images/profesional.jpg" class="img-fluid speakers-image" alt="">
                                    <div class="speakers-info">
                                        <a href="cargarProfesional.php" title="cargue el profesional deseado">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-12 ms-lg-auto mt-4 mt-lg-0">
                            <a class="custom-btn btn">Donate</a>
                        </div>
