    ...
    <body>
        ...
        <main>
            ...
            <?php
                ...
                $consulta = "SELECT personas.nombre AS nombrePersona, apellido, dni, telefono, animal_id, animal.nombre AS nombre, especie FROM animal 
                ...
                $consulta2 = "SELECT personas.nombre AS nombrePersona, apellido, dni, telefono, animal_id, animal.nombre AS nombre, especie FROM animal 
                JOIN personas ON animal.persona_id = personas.persona_id
                WHERE animal.activo = 1 
                AND animal.nombre LIKE '%{$nombreAnimal}%'
                AND personas.nombre LIKE '%{$nombrePersona}%'
