...
/*----------------Primera consulta para contar cantidad de resultados-------------------*/  
    $prueba = "SELECT * FROM protectora WHERE id_persona = '{$Spersona_id}'";
    $resultadop = mysqli_query($Sconexion, $prueba);
    $a = mysqli_fetch_assoc($resultadop);
    var_dump($a['id_persona']);
